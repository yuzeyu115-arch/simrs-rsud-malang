...
<head>
    ...
    <title>Dashboard Pasien - RSUD Kota Malang</title>
    ...
    <main class="max-w-3xl mx-auto p-6">
        ...
        <div class="grid grid-cols-1 gap-4">
            ...
            <div class="bg-white p-4 rounded-lg shadow-sm">
                ...
                <p class="text-sm text-gray-500">Ikuti instruksi dari tim medis. Kontak: (031) 0000-000</p>
            </div>
        </div>

        <div class="mt-8 text-center text-xs text-gray-400">Versi Pasien • Akses publik</div>
    </main>
</body>
</html>
