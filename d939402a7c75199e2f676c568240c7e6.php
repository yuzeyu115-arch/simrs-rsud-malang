...
<body class="bg-gray-50 flex overflow-hidden h-screen">
    ...
    <aside class="w-64 bg-white border-r border-gray-100 flex flex-col flex-shrink-0 shadow-sm z-20">
        ...
        <nav class="flex-1 px-4 space-y-1 overflow-y-auto">
            ...
            <a href="<?php echo e(url('/dashboard')); ?>" class="flex items-center space-x-3 p-3 rounded-xl sidebar-active transition-all text-sm font-semibold">
            ...
            <a href="<?php echo e(url('/jadwal-operasi')); ?>" class="flex items-center space-x-3 p-3 rounded-xl text-gray-500 hover:bg-gray-50 transition-all text-sm font-semibold">
                 <i class="fa-solid fa-calendar-check w-5"></i> <span>Jadwal Operasi</span>
            </a>
            <a href="<?php echo e(url('/rapat-koordinasi')); ?>" class="flex items-center space-x-3 p-3 rounded-xl text-gray-500 hover:bg-gray-50 transition-all text-sm font-semibold">
            ...
            <a href="<?php echo e(url('/bed-manager-list')); ?>" class="flex items-center space-x-3 p-3 rounded-xl text-gray-500 hover:bg-gray-50 transition-all text-sm font-semibold">
                 <i class="fa-solid fa-bed-pulse w-5"></i> <span>Manajemen Bed</span>
            </a>
            <a href="<?php echo e(url('/janji-temu')); ?>" class="flex items-center space-x-3 p-3 rounded-xl text-gray-500 hover:bg-gray-50 transition-all text-sm font-semibold">
            ...
            <a href="<?php echo e(url('/farmasi')); ?>" class="flex items-center space-x-3 p-3 rounded-xl text-gray-500 hover:bg-gray-50 transition-all text-sm font-semibold">
                 <i class="fa-solid fa-pills w-5"></i> <span>Farmasi & Obat</span>
            </a>
            <a href="<?php echo e(url('/logistik/ringkasan-cepat')); ?>" class="flex items-center space-x-3 p-3 rounded-xl text-gray-500 hover:bg-gray-50 transition-all text-sm font-semibold">
            ...
            <a href="<?php echo e(url('/gizi/pemesanan-menu')); ?>" class="flex items-center space-x-3 p-3 rounded-xl text-gray-500 hover:bg-gray-50 transition-all text-sm font-semibold">
                 <i class="fa-solid fa-utensils w-5"></i> <span>Pemesanan Menu</span>
            </a>
            <a href="<?php echo e(url('/gizi/jadwal-makan')); ?>" class="flex items-center space-x-3 p-3 rounded-xl text-gray-500 hover:bg-gray-50 transition-all text-sm font-semibold">
            ...
            <a href="<?php echo e(url('/statistik/tindakan-kunjungan')); ?>" class="flex items-center space-x-3 p-3 rounded-xl text-gray-500 hover:bg-gray-50 transition-all text-sm font-semibold">
            ...
            <a href="<?php echo e(url('/admin/pengguna')); ?>" class="flex items-center space-x-3 p-3 rounded-xl text-gray-500 hover:bg-gray-50 transition-all text-sm font-semibold">
                 <i class="fa-solid fa-users-gear w-5"></i> <span>Manajemen Pengguna</span>
            </a>

            <div class="mt-auto pt-10 px-3 pb-8">
                <a href="<?php echo e(url('/logout')); ?>" class="flex items-center space-x-3 text-red-500 font-bold text-sm hover:underline">
    ...
    <main class="flex-1 overflow-y-auto">
        ...
        <div class="sticky top-0 bg-white/80 backdrop-blur-md border-b border-gray-100 px-8 py-4 z-10 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-6">
                <a href="<?php echo e(url('/notifications')); ?>" class="relative text-gray-400 hover:text-gray-600 transition-colors">
                    <i class="fa-regular fa-bell text-xl"></i>
                    <span class="absolute top-0 right-0 block h-2 w-2 rounded-full bg-red-500 ring-2 ring-white"></span>
                </a>
                <div class="h-8 w-px bg-gray-200"></div>
                <a href="<?php echo e(url('/profile')); ?>" class="flex items-center space-x-3 hover:bg-gray-50 p-2 rounded-xl transition-colors">
        ...
        <div class="p-8">
            <div class="flex justify-between items-end mb-8">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1 font-medium">Ringkasan aktivitas hari ini, <?php echo e(date('d F Y')); ?></p>
                </div>
                <a href="<?php echo e(url('/jadwal-operasi')); ?>" class="bg-primary-green hover:bg-primary-green-hover text-white px-5 py-2.5 rounded-xl text-sm font-bold shadow-lg shadow-primary-green/20 transition-all active:scale-95 flex items-center inline-block">
                ...
                <div class="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm hover:shadow-md transition-all">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                            ...
                            <h3 class="text-3xl font-black text-gray-800"><?php echo e($totalRooms ?? 5); ?></h3>
                        </div>
                    ...
                    <div class="flex items-center text-xs font-bold">
                        <span class="text-green-500"><?php echo e($usedRooms ?? 2); ?> Terpakai</span>
                        <span class="mx-2 text-gray-200">•</span>
                        <span class="text-gray-400"><?php echo e(($totalRooms ?? 5) - ($usedRooms ?? 2)); ?> Kosong</span>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm hover:shadow-md transition-all">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                            ...
                            <h3 class="text-3xl font-black text-gray-800"><?php echo e($availableBeds ?? 45); ?></h3>
                        </div>
                    ...
                    <div class="text-xs font-bold text-emerald-600">
                        <i class="fa-solid fa-arrow-up mr-1"></i> <?php echo e($occupiedBeds ?? 100); ?> bed terisi
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm hover:shadow-md transition-all">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                            ...
                            <h3 class="text-3xl font-black text-gray-800"><?php echo e($criticalStock ?? 3); ?> <span class="text-sm font-medium text-gray-400 uppercase tracking-widest ml-1">item</span></h3>
                        </div>
                        <div class="w-12 h-12 rounded-2xl bg-purple-50 text-purple-500 flex items-center justify-center text-xl shadow-inner">
                            <i class="fa-solid fa-capsules"></i>
                        </div>
                    </div>
                    <a href="<?php echo e(url('/farmasi')); ?>" class="text-xs font-bold text-red-500 hover:underline transition-all">Lihat detail stok</a>
                </div>
                ...
                <div class="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm hover:shadow-md transition-all">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                            ...
                            <h3 class="text-3xl font-black text-gray-800"><?php echo e($operasiHariIni ?? 0); ?></h3>
                        </div>
                        <div class="w-12 h-12 rounded-2xl bg-amber-50 text-amber-500 flex items-center justify-center text-xl shadow-inner">
                            <i class="fa-solid fa-notes-medical"></i>
                        </div>
                    </div>
                    <a href="<?php echo e(url('/jadwal-operasi')); ?>" class="text-xs font-bold text-amber-600 hover:underline">Lihat jadwal</a>
                </div>
            </div>
